...
function get_svg_arrow_next() {
	$rtn = '<svg width="22px" height="22px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="svg2" version="1.1">
	<g transform="rotate(45 1254.793 524.438)">
	<path style="fill:#FFF;fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1" d="M11.532 1048.341H9.536v-9h-9v-2h11z"/>
	</g>
	</svg>';
	echo $rtn;
}
...
function get_svg_arrow_prev() {
	$rtn = '<svg width="22px" height="22px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="svg2" version="1.1">
	<g transform="rotate(45 1254.793 524.438)">
	<path style="fill:#FFF;fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1" d="M15.464 1044.409v-1.997h-9v-9h-2v11z"/>
	</g>
	</svg>';
	echo $rtn;
}
