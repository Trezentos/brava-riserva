...
if(LOCALHOST) {
	define('DB_USER','root');
	define('DB_NAME','brava-riserva');
	define('DB_PASS','');
	define('DB_HOST','localhost');
	define('PREFIX','adm_');
	define('ROOT',$_SERVER['DOCUMENT_ROOT'].'/brava-riserva');
	define('HTTP','http://'.$_SERVER['HTTP_HOST'].'/brava-riserva');
	define('SHIFT_NUM', 1);
	...
	define('DB_NAME','quaxxcom_brava_riserva');
...
$style = [
	'styles/css/smooth-scroll-west.min.css',
	'styles/css/bulma-0.9.3-light.min.css',
