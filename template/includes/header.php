...
<!doctype html>
	...
	<head>
		...
		<?php }else{ ?>
		<meta property="og:image" content="<?php echo IMG; ?>logo-2.png">
				...
				<div class="columns is-mobile">
					...
					<!--
						<nav class="links font-primary waypoint animation_right_dd1 animated is-hidden-touch">
							...
							<a href="#lazer"		  class="smooth-scroll-link" data-smooth-time-link="3000">Lazer</a>
							<a href="#apartamentos"   class="smooth-scroll-link" data-smooth-time-link="5000">Apartamentos</a>
							<a href="#localizacao"    class="smooth-scroll-link" data-smooth-time-link="6000">Localização</a>
							<a href="#contato" 		  class="smooth-scroll-link" data-smooth-time-link="5000">Contato</a>
						</nav>
						-->
